   ...
   /** @scope DG.MultipleLSRLsModel.prototype */
   {
     ...
     synchLSRLs: function() {
       var this_ = this,
          ...
          tIsCategorical = tLegendAttrDescription.get('isCategorical'),
          tCellNames = tIsCategorical ?
                       tLegendAttrDescription.getPath('attributeStats.categoricalStats.cellNames') || [] : [],
