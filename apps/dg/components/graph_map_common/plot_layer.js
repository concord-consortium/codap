  ...
  */
  ...
  updatePlottedElement: function( iPlottedElement, iAttrs, iAnimate, iCallback ) {
    ...
    if( iAnimate) {
      ...
      this.setFillAndStroke( iPlottedElement, iAttrs);
      //iPlottedElement.attr( iAttrs);
      // Instead of calling Raphael, we modify elements 'attrs' property directly
/*
      DG.ObjectMap.forEach( iAttrs, function( iKey, iValue) {
        iPlottedElement.attrs[iKey] = iValue;
      });
*/
