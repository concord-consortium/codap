SC.stringsFor("en", {
    ...
    "DG.TableController.collectionTitleTextWithSetAside": "%@1 (%@2 cases, set aside: %@3)", /* %@1 replaced with case table title, %@2 replaced with case count, %@3 with set-aside count */
