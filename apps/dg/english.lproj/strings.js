SC.stringsFor("en", {
    ...
    "DG.plugin.Sampler.draw-settings.repeat-items-p1": "Repeat",
    "DG.plugin.Sampler.draw-settings.repeat-items-p2": "selecting",
    ...
    "DG.plugin.Sampler.device-add": "Add Device",
    "DG.plugin.Sampler.device-branch": "Add Branch",
    ...
    "DG.plugin.Sampler.collector.noDatasets": "No data available for the collector.",
    "DG.plugin.Sampler.collector.add-or-import": "Add a table or import a CSV file.",
    "DG.plugin.Sampler.collector.select-prompt": "Select a data context",
    ...
    "DG.plugin.Sampler.selection-options.replacement-per-device": "replacement controlled per device",
    "DG.plugin.Sampler.device-icon.with-replacement": "With replacement",
    "DG.plugin.Sampler.device-icon.without-replacement": "Without replacement",
    "DG.plugin.Sampler.device-icon.spinner.replacement": "With replacement cannot be changed for Spinner",
    "DG.plugin.Sampler.options.item-labels": "Set item labels",
    ...
    "DG.plugin.Sampler.sample-list.prompt": "Enter a list (e.g. 'cat, cat, dog') or a range (e.g. '1-50', '-5 to 5', '1.0 to 5.0', 'A-Z')",
    "DG.plugin.Sampler.sample-list.initial-value": "a to c",
    "DG.plugin.Sampler.sample-list.ok": "OK",
    "DG.plugin.Sampler.sample-list.cancel": "Cancel",
    ...
    "DG.plugin.Sampler.dataset.attr-sample_size": "sample size",
    "DG.plugin.Sampler.dataset.attr-until_formula": "formula for until",
    ...
    "DG.plugin.Sampler.measures.instructions": "Add common measures using formulas for each sample using the form below.",
    "DG.plugin.Sampler.measures.select-prompt": "Select formula:",
    "DG.plugin.Sampler.measures.select-measure": "Select a formula: ",
    "DG.plugin.Sampler.measures.name-prompt": "Name the measure: ",
    "DG.plugin.Sampler.measures.name-hint": "Enter measure name here (optional)",
    "DG.plugin.Sampler.measures.add-measure": "Add Measure",
    "DG.plugin.Sampler.measures.customize": "Customize formula:",
    ...
    "DG.plugin.Sampler.tooltip.hide-device": "Hide the device",
    "DG.plugin.Sampler.tooltip.show-device": "Show the device",
    "DG.plugin.Sampler.tooltip.delete-device": "Delete the device",
    "DG.plugin.Sampler.tooltip.add-item": "Add an item to the device",
    "DG.plugin.Sampler.tooltip.remove-item": "Remove the last added item from the device",
    "DG.plugin.Sampler.tooltip.specify-items": "Specify items for the device",
    "DG.plugin.Sampler.tooltip.choose-mixer": "Choose Mixer for this device",
    "DG.plugin.Sampler.tooltip.choose-spinner": "Choose Spinner for this device",
    "DG.plugin.Sampler.tooltip.choose-collector": "Choose the Collector device",
    "DG.plugin.Sampler.tooltip.add-device": "Add a new device to the Sampler",
    "DG.plugin.Sampler.tooltip.select-repeat": "Choose between Select and Repeat",
    "DG.plugin.Sampler.tooltip.replacement": "Choose between with and without replacement",
    "DG.plugin.Sampler.tooltip.clear-data": "Delete all the sampled items from the dataset",
    "DG.plugin.Sampler.tooltip.sampling-speed": "Choose how fast to sample items",
    "DG.plugin.Sampler.tooltip.start-sampling": "Start the sampling simulation",
    "DG.plugin.Sampler.tooltip.pause-sampling": "Pause the sampling simulation",
    "DG.plugin.Sampler.tooltip.stop-sampling": "Stop the sampling simulation",
    "DG.plugin.Sampler.tooltip.pass-through": "Determine which items pass through",
