...
/* eslint eqeqeq: "off", semi: "off", block-scoped-var: "off" */
/* jshint eqeqeq:false, asi:true */
...
var nodeDeepEqual = function (actual, expected, opts) {
...
function objEquiv(a, b, opts) {
  ...
  for (i = ka.length - 1; i >= 0; i--) {
    key = ka[i];
    if (!nodeDeepEqual(a[key], b[key], opts)) return false;
  }
