...
SC.stringsFor('English', {
  ...
  'DG.AppController.saveDocument.error.permissions' : "The document could not be saved. Try exporting locally (file->Export CODAP Document) or logging in to Document Server.",
