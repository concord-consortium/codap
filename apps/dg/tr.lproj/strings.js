SC.stringsFor("tr", {
    ...
    "DG.ToolButtonData.tileListMenu.title": "Karolar",
    "DG.ToolButtonData.tileListMenu.toolTip": "Dosyadaki karoların listesini göster",
    ...
    "DG.DocumentController.caseCardTitle": "Durum Kartı",
    ...
    "DG.Inspector.graphBarForEachPoint": "Her nokta için sütun",
    ...
    "DG.plugin.Sampler.draw-settings.select-items-p2": "nesneler",
    ...
    "DG.plugin.Sampler.reset-text": "VERİLERİ SİL",
    ...
    "DG.plugin.Sampler.password-options.lock-title": "Şifre ile ayarları kilitle:",
    "DG.plugin.Sampler.password-options.lock": "Kilitle",
    "DG.plugin.Sampler.password-options.unlock-title": "Şifre ile ayarların kilidini aç:",
    ...
    "DG.plugin.Sampler.sample-list.parse-error": "Üzgünüz. Girdiğiniz ifadeyi uygulayamadık. Kullanabileceğiniz birkaç geçerli liste ve bir dizi ifade şu şekildedir: 'a,b,b,b', 'kedi,kedi,köpek', '1-50', '-5 to 5', '1.0 to 5.0', veya 'A-Z'",
    ...
    "DG.plugin.Sampler.dataset.name": "Örnekleyici",
    ...
    "DG.plugin.Sampler.dataset.col-items": "nesneler",
    "DG.plugin.sampler.experiment.description": "%@1 içeren %@2 %@3%@4(%@5)",
    "DG.plugin.sampler.experiment.no-description": "gizli!",
    "DG.plugin.sampler.experiment.description-mixer-item-kind": "nesneler",
    ...
    "DG.plugin.MicrodataPortal.description": "ABD nüfus sayımındaki popülasyonları bireysel düzeyde inceleyin.",
