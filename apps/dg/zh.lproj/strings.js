SC.stringsFor("zh", {
    ...
    "DG.Undo.slider.changeMultiples": "回復更改滑桿 multiples restriction(zh)",
    "DG.Redo.slider.changeMultiples": "重做更改滑桿 multiples restriction(zh)",
    "DG.Undo.slider.changeSpeed": "回復更改滑桿 max frames/sec",
    "DG.Redo.slider.changeSpeed": "重做更改滑桿 max frames/sec",
    ...
    "DG.CaseTable.indexMenu.insertCases": "插多案例...",
    "DG.CaseTable.indexMenu.deleteCase": "刪除一個案例",
    "DG.CaseTable.indexMenu.deleteCases": "刪除多案例",
    ...
    "DG.CaseTableController.allTables": "都表格",
