...
context("case card", () => {
  ...
  describe("case card", () => {
    ...
    it("displays cases and allows user to scroll through them", () => {
      ...
      cy.get('[data-testid="case-card-view-title"]').should("have.text", "Cases")
      cy.get('[data-testid="case-card-view-previous-button"]').should("not.be.disabled")
      ...
      cy.get('[data-testid="case-card-view-previous-button"]').click()
      cy.get('[data-testid="case-card-view-index"]').should("have.text", "27 of 27")
      card.getAttributeValues().first().should("have.text", "Spotted Hyena")
      cy.get('[data-testid="case-card-view-previous-button"]').click()
      card.getAttributeValues().first().should("have.text", "Red Fox")
      cy.get('[data-testid="case-card-view-next-button"]').should("not.be.disabled").click()
      card.getAttributeValues().first().should("have.text", "Spotted Hyena")
      cy.get('[data-testid="case-card-view-next-button"]').should("be.disabled")
    })
    it("displays case data in a hierarchy when there is a parent collection", () => {
      ...
      cy.get('[data-testid="case-card-view-previous-button"]').should("have.length", 2).and("not.be.disabled")
    ...
    it("allows the user to add, edit, and hide attributes with undo/redo", () => {
      ...
      card.getAttributeValueEditors().eq(9)
