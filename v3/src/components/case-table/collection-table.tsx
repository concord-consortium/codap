...
export const CollectionTable = observer(function CollectionTable(props: IProps) {
  ...
  // No handlePointerLeave needed — the document-level pointerup handler
  // handles cleanup, and we must not stop auto-scroll when the pointer
  // leaves the component during marquee selection.
