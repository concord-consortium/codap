...
export const CopyToClipboardModal = observer(function CopyToClipboardModal({ isOpen, onClose }: IProps) {
  ...
  const applyAndClose = () => {
    if (dataSet) navigator.clipboard.writeText(convertDatasetToCsv(dataSet, selectedCollection))
    closeModal()
  }
