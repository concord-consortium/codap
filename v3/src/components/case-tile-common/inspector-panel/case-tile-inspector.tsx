...
import { ICaseCardModel, isCaseCardModel } from "../../case-card/case-card-model"
import { useDataSet } from "../../../hooks/use-data-set"
import { DataSetContext } from "../../../hooks/use-data-set-context"
import { CaseMetadataContext } from "../../../hooks/use-case-metadata"
import { logStringifiedObjectMessage } from "../../../lib/log-message"
import { CaseTileModelContext } from "../use-case-tile-model"

import "./case-tile-inspector.scss"

export const CaseTileInspector = ({ tile, show }: ITileInspectorPanelProps) => {
  const [showInfoModal, setShowInfoModal] = useState(false)
  const caseTileModel: ICaseCardModel | ICaseTableModel | undefined =
    isCaseTableModel(tile?.content) || isCaseCardModel(tile?.content) ? tile?.content : undefined
  ...
  return (
    <DataSetContext.Provider value={data}>
      <CaseMetadataContext.Provider value={metadata}>
        <CaseTileModelContext.Provider value={caseTileModel}>
          <InspectorPanel component="case-tile" show={show}>
            ...
            {isCaseTableModel(caseTileModel) &&
