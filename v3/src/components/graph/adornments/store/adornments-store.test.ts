...
describe("AdornmentsStore", () => {
  ...
  it("can have its showSquaresOfResiduals property set", () => {
    ...
    adornmentsStore.toggleShowSquaresOfResiduals()
    expect(adornmentsStore.showSquaresOfResiduals).toBe(false)
    adornmentsStore.setShowSquaresOfResiduals(true)
    expect(adornmentsStore.showSquaresOfResiduals).toBe(true)
    adornmentsStore.setShowSquaresOfResiduals(false)
    expect(adornmentsStore.showSquaresOfResiduals).toBe(false)
  })
  it("can have its showResidualPlot property set", () => {
    const adornmentsStore = AdornmentsStore.create()
    expect(adornmentsStore.showResidualPlot).toBe(false)
    adornmentsStore.toggleShowResidualPlot()
    expect(adornmentsStore.showResidualPlot).toBe(true)
    adornmentsStore.toggleShowResidualPlot()
    expect(adornmentsStore.showResidualPlot).toBe(false)
    adornmentsStore.setShowResidualPlot(true)
    expect(adornmentsStore.showResidualPlot).toBe(true)
    adornmentsStore.setShowResidualPlot(false)
    expect(adornmentsStore.showResidualPlot).toBe(false)
  })
