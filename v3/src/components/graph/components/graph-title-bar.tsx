...
export const GraphTitleBar = ({tile,  isEditingTitle, onCloseTile, setIsEditingTitle, onHandleTitleBarClick}: ITileTitleBarProps) => {
  ...
  return (
    <ComponentTitleBar component={"graph"} tileId={tileId}>
