...
describe('GraphContentModel', () => {
  it('should create an instance with defaults', () => {
    ...
    expect(graphModel.pointDescription._pointColors).toStrictEqual([defaultPointColor])
    expect(graphModel.pointDescription._pointStrokeColor).toBe(defaultStrokeColor)
