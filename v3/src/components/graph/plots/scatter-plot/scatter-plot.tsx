...
export const ScatterPlot = observer(function ScatterPlot({ renderer }: IPlotProps) {
  ...
  }, [adornmentsStore, graphModel, refreshConnectingLines])
  ...
  useEffect(function restyleConnectingLinesSelection() {
    ...
    }, { name: "ScatterDots.restyleConnectingLinesSelection" }, graphModel)
  }, [adornmentsStore, dataConfiguration, graphModel])
