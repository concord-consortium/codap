...
export const HelloTitleBar = ({tile, isEditingTitle, onCloseTile, setIsEditingTitle, onHandleTitleBarClick}: ITileTitleBarProps) => {
  ...
  return (
    <ComponentTitleBar component={"hello"} tileId={tileId}>
