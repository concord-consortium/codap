...
export const InspectorPanel = ({component}: IProps) => {
  const tableInpectors = ["datasetInfo", "resize", "trash", "hide_show", "values"]
  ...
  return (
    ...
    `{showInfoModal &&
      <DatasetInfoModal showInfoModal={showInfoModal} setShowInfoModal={setShowInfoModal} />}
    </>
