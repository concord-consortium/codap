...
// Taken from https://github.com/pyalot/webgl-heatmap as it's an old library and it isn't published to NPM.
...
WebGLHeatmap = (function() {
  function WebGLHeatmap(_arg) {
    ...
    if (gradientTexture) {
      console.log("gradientTexture", gradientTexture)
...
export const createWebGLHeatmap = (options) => new WebGLHeatmap(options)
