...
describe("Attribute", () => {
  ...
  test("Basic Attribute functionality", () => {
    ...
    expect(attribute.valueIsNumeric(0)).toBe(true)
    expect(attribute.valueIsNumeric(3)).toBe(true)
    ...
    expect(attribute.valueIsNumeric(3)).toBe(false)
    ...
    expect(attribute.valueIsNumeric(5)).toBe(false)
