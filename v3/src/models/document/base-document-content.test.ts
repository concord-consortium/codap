...
import { BaseDocumentContentModel, IBaseDocumentContentModel } from "./base-document-content"
import { FreeTileRow } from "./free-tile-row"
import { LegacyTileRowModel } from "./legacy-tile-row"

registerTileTypes(["Test"])

describe("BaseDocumentContent", () => {
  let content: IBaseDocumentContentModel

  beforeEach(() => {
    content = BaseDocumentContentModel.create({})
  })
