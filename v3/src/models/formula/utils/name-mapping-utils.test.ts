import { CASE_INDEX_FAKE_ATTR_ID, isCanonicalName } from "../formula-types"
import {
  getCanonicalNameMap, getDisplayNameMap, globalValueIdToCanonical, idToCanonical, localAttrIdToCanonical,
  safeSymbolName
